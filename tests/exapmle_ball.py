...
L, S = decomper.decomp_via_3mat(D0, width, height, frames)
...
#save bg & masks
loader.save('../output/ball/3mat/background', 'bg', L * 255, width, height, frames)
loader.save('../output/ball/3mat/masks', 'mask', M, width, height, frames)